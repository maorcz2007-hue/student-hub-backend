...
class _$AssignmentImpl implements _Assignment {
  ...
  @override
  String toString() {
    return 'Assignment(id: $id, title: $title, description: $description, course: $course, dueDate: $dueDate, priority: $priority, progress: $progress, completed: $completed)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, description, course,
      dueDate, priority, progress, completed);
...
abstract class _Assignment implements Assignment {
  const factory _Assignment(
      ...
      final bool completed}) = _$AssignmentImpl;
